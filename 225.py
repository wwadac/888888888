...
└ Premium: `{'Да' if getattr(user, 'premium', False) else 'Нет'}`
    ...
    async def send_complaint_animation(self, event, user_id, target_username):
        ...
        try:
            ...
            animation_steps = [
    "🔄 🛜 10% | ▁▂▃▄▅▆▇█ | Запуск протокола...",
    "🔄 🛜 20% | ▁▂▃▄▅▆▇█ | Сканирование цели...", 
    "🔄 📡 30% | ▁▂▃▄▅▆▇█ | Сбор информации...",
    "🔄 📡 40% | ▁▂▃▄▅▆▇█ | Генерация контента...",
    "🔄 🚀 50% | ▁▂▃▄▅▆▇█ | Отправка волны 1...",
    "🔄 🚀 60% | ▁▂▃▄▅▆▇█ | Отправка волны 2...",
    "🔄 🚀 70% | ▁▂▃▄▅▆▇█ | Отправка волны 3...",
    "🔄 ⚡ 80% | ▁▂▃▄▅▆▇█ | Обработка ответов...",
    "🔄 ⚡ 90% | ▁▂▃▄▅▆▇█ | Анализ эффективности...",
    "🔄 ⚡ 95% | ▁▂▃▄▅▆▇█ | Финальный отчет...",
    "✅ ✅ 100% | ▁▂▃▄▅▆▇█ | Миссия выполнена!"
]
            
            for step in animation_steps:
                await asyncio.sleep(2.5)  # Увеличенная задержка для драматизма
